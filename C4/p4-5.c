...
/* Programa que simula una calculadora basica, y al cual se le ha agregado las operacion modulo, sin, cos, exp y es fascil extender a cualquier funcion univariable*/
/* Numero de programa (El lenguaje de programacion C, R&K, segunda edicion): 4.5 */
